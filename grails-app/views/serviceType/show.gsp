...
<html>
    ...
    <body>
        ...
        <div id="show-serviceType" class="content scaffold-show" role="main">
            ...
            <f:display bean="serviceType" />
            <g:form resource="${this.serviceType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.serviceType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
